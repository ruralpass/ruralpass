          ...
          <td style="background:#ffffff;padding:36px 40px;">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e2e8f0;border-radius:12px;overflow:hidden;margin-bottom:24px;">
              ...
              <tr style="background:#fafafa;">
                ...
                <td style="padding:14px 20px;border-bottom:1px solid #f1f5f9;font-size:15px;color:#0f172a;"><a href="tel:${telefono}" style="color:#1a4a8a;font-weight:700;text-decoration:none;">${telefono}</a></td>
              </tr>
              <tr>
            ...
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td style="padding-right:8px;" width="50%">
                  <a href="https://wa.me/56956277070?text=Hola%20${encodeURIComponent(nombre)}%2C%20recibimos%20tu%20cotizacion." style="display:block;background:#25d366;color:#fff;font-size:14px;font-weight:700;text-align:center;text-decoration:none;padding:14px 20px;border-radius:10px;">💬 Responder por WhatsApp</a>
                </td>
                <td style="padding-left:8px;" width="50%">
                  <a href="tel:${telefono}" style="display:block;background:#0f2d5e;color:#fff;font-size:14px;font-weight:700;text-align:center;text-decoration:none;padding:14px 20px;border-radius:10px;">📞 Llamar al cliente</a>
                </td>
              </tr>
            </table>
          </td>
